...
cobc -x main.cbl repeat-wrapper.cbl -fstatic-call -Lbuild -lrepeat -o build/main && \
./build/main
```
...
cobc -x main.cbl repeat-wrapper.cbl -fstatic-call build\repeat.lib -o build\main
.\build\main
```
